...
public class divisionTutorial extends AppCompatActivity {
    ...
    private SlideAdapterDiv slideAdapterdiv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startQuiz = findViewById(R.id.btnStartQuiz4);
        mSlideViewPager = findViewById(R.id.slideViewPager);
        dotsLayout = findViewById(R.id.dots);

        slideAdapterdiv = new SlideAdapterDiv(this);
        mSlideViewPager.setAdapter(slideAdapterdiv);
