...
public class gamePTS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewLargest1 = findViewById(R.id.largest1);
        textViewLargest2 = findViewById(R.id.largest2);
        textViewLargest3 = findViewById(R.id.largest3);
        textViewLargest4 = findViewById(R.id.largest4);
        textViewLargest5 = findViewById(R.id.largest5);
        textViewLargest6 = findViewById(R.id.largest6);
    ...
    private void startCountDownToGameStart() {
        countDownToGameStart = new CountDownTimer(timeLeftToStart, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                textViewGameDescription.setText("Find the Smallest Number!");
            }
    ...
    public List<LargestQuestion> generateQuestion() {
        ...
        for(int i = 1; i < 36; i++) {
            ...
            for(int k = 0; k < j; k++) { // each question have a number of numbers to declare, so we iterate base on how many number the question has
                ...
                if(tempRandomNumber < answer) { //get the smallest number as the answer
    ...
    private void endGame(){
        ...
        int tempScore = Integer.parseInt(userInfo.get(SessionManager.KEY_LSS2));
        if(tempScore < score) {
            sessionManager.setKeyLss2(score);
            boolean isUpdated = db.updateScore(9, score, userInfo.get(SessionManager.KEY_USERNAME));
        ...
        intent.putExtra("GameType", "Smallest");
